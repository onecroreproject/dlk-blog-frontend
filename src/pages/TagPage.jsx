  ...
  if (loading) {
    return (
      <div className="bg-gray-50 min-h-screen py-20 flex flex-col items-center justify-center">
        ...
        <p className="text-gray-400 font-black uppercase tracking-widest text-xs">Loading posts for #{tag}...</p>
      </div>
    );
  }
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="bg-white border-b py-10 px-6">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <h1 className="text-3xl font-black text-gray-900 uppercase tracking-tighter">Tag: #{tag}</h1>
          ...
          <div className="lg:col-span-8 flex flex-col gap-10">
            {filteredPosts.length > 0 ? (
                  ...
                  <div className="p-10">
                    <div className="flex items-center gap-4 text-[10px] font-black text-gray-400 mb-6 uppercase tracking-widest">
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 rounded-full bg-red-50 flex items-center justify-center border border-red-100 overflow-hidden text-red-600 font-black uppercase text-[8px]">
                    ...
                    <Link to={`/blog/${post.slug || post._id}`}>
                      <button className="bg-red-600 text-white font-black text-[11px] uppercase tracking-[2px] px-8 py-4 rounded-xl hover:bg-red-700 transition-all shadow-lg shadow-red-100">
                        Read More
                      </button>
                    </Link>
                  </div>
              ...
              <div className="text-center py-32 bg-white rounded-[40px] border border-gray-100 shadow-sm">
                <h2 className="text-xl font-black text-gray-300 uppercase tracking-widest">No Posts Found with tag #{tag}</h2>
