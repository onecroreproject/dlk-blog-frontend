            ...
            <div key={post.id} className="flex flex-col md:flex-row gap-6 group cursor-pointer bg-white border border-gray-100 rounded-2xl overflow-hidden hover:shadow-xl transition-all duration-300">
              ...
              <div className="md:w-3/5 p-4 flex flex-col justify-center">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-sm text-gray-600 font-medium">by {post.author} • {post.date}</span>
                </div>
                <h3 className="text-xl font-bold text-gray-900 leading-tight mb-3 group-hover:text-blue-600 transition-colors">
                  {post.title}
                </h3>
                <p className="text-gray-500 text-base line-clamp-2 mb-4 leading-relaxed">
                  {post.excerpt}
                </p>
            ...
            <div key={post.id} className="relative h-[350px] rounded-2xl overflow-hidden group cursor-pointer shadow-lg">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent p-6 flex flex-col justify-end">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-xs text-white font-medium">by {post.author} • {post.date}</span>
                </div>
                <h4 className="text-white font-bold text-lg leading-tight mb-3 group-hover:text-blue-400 transition-colors">
                  {post.title}
                </h4>
